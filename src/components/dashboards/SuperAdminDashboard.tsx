...
import { Building2, Users, TrendingUp, CheckCircle, Search, Edit, Upload, School as SchoolIcon, Phone, MapPin, Calendar, ArrowLeft, Eye, Plus } from 'lucide-react';
...
export const SuperAdminDashboard = ({ onNavigate }: SuperAdminDashboardProps) => {
  ...
  const activeSchools = schools.filter(s => s.activeUsers > 0).length;
  ...
  const allUserGrowthData = [
    ...
    { month: 'Jun 2024', date: '2024-06', users: 2650, daysAgo: 150 },
  ...
  const handleAddSchool = () => {
    if (!newSchool.name || !newSchool.principalName || !newSchool.address || !newSchool.city || !newSchool.state || !newSchool.pincode) {
      toast.error(language === 'en' ? 'Please fill in all required fields' : 'దయచేసి అన్ని అవసరమైన ఫీల్డ్‌లను పూరించండి');
      return;
    }
    ...
    toast.success(language === 'en' ? 'School added successfully!' : 'పాఠశాల విజయవంతంగా జోడించబడింది!');
  };
  ...
  const handleUpdateSchool = () => {
    ...
    setViewMode('details');
    toast.success(language === 'en' ? 'School updated successfully!' : 'పాఠశాల విజయవంతంగా నవీకరించబడింది!');
  };

  const filteredSchools = schools.filter(school =>
    school.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
    school.principalName.toLowerCase().includes(searchQuery.toLowerCase()) ||
    (school.nameInTelugu && school.nameInTelugu.includes(searchQuery))
  );
            ...
            <div className="grid gap-6">
                  ...
                  <Label htmlFor="logo-upload" className="cursor-pointer">
                    <Button type="button" variant="outline" asChild>
                      <span>
                        ...
                        {language === 'en' ? 'Upload Logo' : 'లోగోను అప్‌లోడ్ చేయండి'}
                      </span>
                    </Button>
                  </Label>
                  <Input
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label>{language === 'en' ? 'School Name (English)' : 'పాఠశాల పేరు (ఇంగ్లీష్)'} *</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label>{language === 'en' ? 'School Name (Telugu)' : 'పాఠశాల పేరు (తెలుగు)'}</Label>
                  <Input
                    value={newSchool.nameInTelugu}
                    onChange={(e) => setNewSchool({ ...newSchool, nameInTelugu: e.target.value })}
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label>{language === 'en' ? 'Principal Name' : 'ప్రిన్సిపాల్ పేరు'} *</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label>{language === 'en' ? 'Principal Phone' : 'ప్రిన్సిపాల్ ఫోన్'}</Label>
                  <Input
              ...
              {/* Address */}
              <div className="space-y-2">
                <Label>{language === 'en' ? 'Street Address' : 'వీధి చిరునామా'} *</Label>
                <Textarea
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  <Label>{language === 'en' ? 'City' : 'నగరం'} *</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label>{language === 'en' ? 'State' : 'రాష్ట్రం'} *</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label>{language === 'en' ? 'Pincode' : 'పిన్‌కోడ్'} *</Label>
                  <Input
              ...
              {/* Primary Color */}
              <div className="space-y-2">
                <Label>{language === 'en' ? 'Primary Brand Color' : 'ప్రాథమిక బ్రాండ్ రంగు'}</Label>
                <div className="flex gap-4 items-center">
                  <Input
                    ...
                    className="w-20 h-12"
                  />
                  <span className="text-sm text-muted-foreground">{newSchool.primaryColor}</span>
                </div>
              </div>

              {/* Action Buttons */}
              <div className="flex gap-4 pt-4">
                <Button onClick={handleAddSchool} className="flex-1" size="lg">
                  {language === 'en' ? 'Add School' : 'పాఠశాల జోడించండి'}
                </Button>
        ...
        <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 rounded-2xl p-8 text-white shadow-xl">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl font-bold mb-2">
                  {language === 'en' ? selectedSchool.name : selectedSchool.nameInTelugu || selectedSchool.name}
                </h1>
                <p className="text-lg text-white/90">
                  {language === 'en' ? 'School Details' : 'పాఠశాల వివరాలు'}
                </p>
              </div>
            </div>
            <Button onClick={handleEditSchool} variant="secondary">
          ...
          <Card className="card-3d">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                {language === 'en' ? 'Basic Information' : 'ప్రాథమిక సమాచారం'}
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl">
                <p className="text-sm text-muted-foreground mb-1">{language === 'en' ? 'School Name' : 'పాఠశాల పేరు'}</p>
                <p className="font-medium text-lg">{selectedSchool.name}</p>
                {selectedSchool.nameInTelugu && (
                  <p className="text-sm text-muted-foreground mt-1">{selectedSchool.nameInTelugu}</p>
                )}
              </div>
          ...
          <Card className="card-3d">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                {language === 'en' ? 'Principal Information' : 'ప్రిన్సిపాల్ సమాచారం'}
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="p-4 bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl">
                <p className="text-sm text-muted-foreground mb-1">{language === 'en' ? 'Principal Name' : 'ప్రిన్సిపాల్ పేరు'}</p>
                <p className="font-medium text-lg">{selectedSchool.principalName}</p>
              </div>
              {selectedSchool.principalPhone && (
                <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl">
                  ...
                  <p className="font-medium text-lg">{selectedSchool.principalPhone}</p>
                </div>
              )}
            </CardContent>
          </Card>
        ...
        <Card className="card-3d">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {language === 'en' ? 'Platform Statistics' : 'ప్లాట్‌ఫారమ్ గణాంకాలు'}
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3">
              <div className="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl text-center">
                <p className="text-sm text-muted-foreground mb-2">{language === 'en' ? 'Active Users' : 'క్రియాశీల వినియోగదారులు'}</p>
                <p className="text-3xl font-bold text-blue-600">{selectedSchool.activeUsers}</p>
              </div>
              <div className="p-6 bg-gradient-to-br from-emerald-50 to-green-50 rounded-xl text-center">
                <p className="text-sm text-muted-foreground mb-2">{language === 'en' ? 'Status' : 'స్థితి'}</p>
                <Badge variant={selectedSchool.activeUsers > 0 ? 'default' : 'secondary'} className="text-lg px-4 py-2">
                  {selectedSchool.activeUsers > 0 
                    ? (language === 'en' ? 'Active' : 'క్రియాశీల')
                    : (language === 'en' ? 'Inactive' : 'క్రియాశీల కాదు')
                  }
                </Badge>
              </div>
              <div className="p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl text-center">
                <p className="text-sm text-muted-foreground mb-2">{language === 'en' ? 'Brand Color' : 'బ్రాండ్ రంగు'}</p>
                <div className="flex items-center justify-center gap-2 mt-2">
                  <div 
                    className="w-12 h-12 rounded-lg border-2 border-gray-300" 
                    style={{ backgroundColor: selectedSchool.primaryColor }}
                  />
                  <span className="text-sm font-medium">{selectedSchool.primaryColor}</span>
                </div>
              </div>
            </div>
          </CardContent>
      ...
      <div className="space-y-6 pb-8">
        <div className="flex items-center gap-4">
          <Button variant="outline" onClick={() => setViewMode('details')}>
            <ArrowLeft className="w-4 h-4 mr-2" />
            {language === 'en' ? 'Back to Details' : 'వివరాలకు తిరిగి'}
          </Button>
        </div>

        <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 rounded-2xl p-8 text-white shadow-xl">
          <h1 className="text-4xl font-bold mb-2">
            {language === 'en' ? 'Edit School' : 'పాఠశాలను సవరించు'}
          </h1>
          <p className="text-lg text-white/90">
            {language === 'en' ? selectedSchool.name : selectedSchool.nameInTelugu || selectedSchool.name}
          </p>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditSchool({ ...editSchool, nameInTelugu: e.target.value })}
                  />
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditSchool({ ...editSchool, principalName: e.target.value })}
                  />
                </div>
                <div className="space-y-2">
                  <Label>{language === 'en' ? 'Principal Phone' : 'ప్రిన్సిపాల్ ఫోన్'}</Label>
                  <Input
                    ...
                    onChange={(e) => setEditSchool({ ...editSchool, principalPhone: e.target.value })}
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-4 items-center">
                  <Input
                    ...
                    onChange={(e) => setEditSchool({ ...editSchool, primaryColor: e.target.value })}
                    className="w-20 h-12"
                  />
                  <span className="text-sm text-muted-foreground">{editSchool.primaryColor}</span>
                </div>
              </div>

              {/* Action Buttons */}
              <div className="flex gap-4 pt-4">
                <Button onClick={handleUpdateSchool} className="flex-1" size="lg">
                  {language === 'en' ? 'Save Changes' : 'మార్పులను సేవ్ చేయండి'}
                </Button>
                <Button onClick={() => setViewMode('details')} variant="outline" className="flex-1" size="lg">
                  {language === 'en' ? 'Cancel' : 'రద్దు చేయండి'}
                </Button>
              </div>
            </div>
    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl mb-2">
          {t('dashboard.welcome')}, {language === 'en' ? 'Super Admin' : 'సూపర్ అడ్మిన్'}
        </h1>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="card-3d hover:shadow-xl transition-shadow cursor-pointer" onClick={() => onNavigate('schools')}>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm">{language === 'en' ? 'Total Schools' : 'మొత్తం పాఠశాలలు'}</CardTitle>
            <Building2 className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl">{totalSchools}</div>
            <p className="text-xs text-muted-foreground">
              {language === 'en' ? 'Onboarded schools' : 'ఆన్‌బోర్డ్ చేసిన పాఠశాలలు'}
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="card-3d hover:shadow-xl transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm">{language === 'en' ? 'Total Users' : 'మొత్తం వినియోగదారులు'}</CardTitle>
            <Users className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl">{totalActiveUsers}</div>
            <p className="text-xs text-muted-foreground">
              {language === 'en' ? 'Across all schools' : 'అన్ని పాఠశాలల్లో'}
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="card-3d hover:shadow-xl transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm">{language === 'en' ? 'Active Schools' : 'క్రియాశీల పాఠశాలలు'}</CardTitle>
            <CheckCircle className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl">{activeSchools}</div>
            <p className="text-xs text-muted-foreground">
              {language === 'en' ? 'Out of' : 'మొత్తం'} {totalSchools} {language === 'en' ? 'schools' : 'పాఠశాలలు'}
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="card-3d hover:shadow-xl transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm">{language === 'en' ? 'Platform Growth' : 'ప్లాట్‌ఫారమ్ వృద్ధి'}</CardTitle>
            <TrendingUp className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl">+45%</div>
            <p className="text-xs text-muted-foreground">
              {language === 'en' ? 'This quarter' : 'ఈ త్రైమాసికం'}
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      {/* Charts */}
      <div ref={analyticsRef} className="grid gap-4 md:grid-cols-2">
        <Card className="card-3d">
          <CardHeader>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <CardTitle>{language === 'en' ? 'School Onboarding Trend' : 'పాఠశాల ఆన్‌బోర్డింగ్ ధోరణి'}</CardTitle>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={schoolGrowth}>
                ...
                <YAxis />
                <Tooltip />
                <Bar dataKey="schools" fill="#4F46E5" name={language === 'en' ? 'Schools' : 'పాఠశాలలు'} radius={[8, 8, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
        ...
        <Card className="card-3d">
          <CardHeader>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <CardTitle>{language === 'en' ? 'User Growth Trend' : 'వినియోగదారు వృద్ధి ధోరణి'}</CardTitle>
      ...
      <Card className="card-3d">
        <CardHeader className="flex flex-row items-center justify-between space-y-0">
          <CardTitle>{language === 'en' ? 'All Schools' : 'అన్ని పాఠశాలలు'}</CardTitle>
        ...
        <CardContent>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead>{language === 'en' ? 'School Name' : 'పాఠశాల పేరు'}</TableHead>
                <TableHead>{language === 'en' ? 'Principal' : 'ప్రిన్సిపాల్'}</TableHead>
                <TableHead>{language === 'en' ? 'Location' : 'స్థానం'}</TableHead>
                <TableHead>{language === 'en' ? 'Active Users' : 'క్రియాశీల వినియోగదారులు'}</TableHead>
                ...
                <TableRow key={school.id}>
                  <TableCell>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p>{language === 'en' ? school.name : school.nameInTelugu || school.name}</p>
                        {language === 'en' && school.nameInTelugu && (
                          <p className="text-xs text-muted-foreground">{school.nameInTelugu}</p>
                        )}
                      </div>
                    </div>
                  </TableCell>
                  ...
                  <TableCell>
                    <Badge variant={school.activeUsers > 0 ? 'default' : 'secondary'}>
                      {school.activeUsers}
                    </Badge>
                  </TableCell>
      ...
      <Card className="card-3d">
        ...
        <CardContent className="grid gap-2 md:grid-cols-2">
          <Button variant="outline" className="justify-start gap-2" onClick={scrollToAnalytics}>
            <TrendingUp className="h-4 w-4" />
            {language === 'en' ? 'View Analytics' : 'విశ్లేషణను చూడండి'}
          </Button>
          <Button variant="outline" className="justify-start gap-2" onClick={() => onNavigate('analytics')}>
            <Building2 className="h-4 w-4" />
            {language === 'en' ? 'Detailed Analytics' : 'వివరణాత్మక విశ్లేషణ'}
          </Button>
        </CardContent>
      </Card>
    </div>
